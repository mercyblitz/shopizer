...
public class DocumentationConfiguration {
    ...
    final Predicate<RequestHandler> requestHandlers() {
        Predicate<RequestHandler>[] matchers = ArrayUtils.of(
                basePackage("com.salesmanager.shop.store.api.v1"),
                basePackage("com.salesmanager.shop.store.api.v2")
        );
        return (Predicate<RequestHandler>) Predicates.or(matchers);
    }
