...
public class CategoryServiceImpl extends SalesManagerEntityServiceImpl<Long, Category> implements CategoryService {
    ...
    public void delete(Category category) throws ServiceException {
        ...
        List<Category> categories = this.getListByLineage(category.getMerchantStore(), category.getLineage() + category.getId() + Constants.SLASH);
    ...
    public void addChild(Category parent, Category child) throws ServiceException {
        ...
        try {
            ...
            if (parent == null) {
                ...
                child.setLineage(lineage + Constants.SLASH + child.getId() +
                        Constants.SLASH);

            }

            update(child);
            List<Category> subCategories = getListByLineage(child.getMerchantStore(), child.getLineage() + child.getId() + "/");
